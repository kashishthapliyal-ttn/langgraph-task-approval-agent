...
export const PIPELINE_STEPS: PipelineStepDef[] = [
  {
    ...
    detail: "Understanding what you want from the uploaded schema.",
  },
  {
    id: "sql",
    title: "Creating SQL",
    detail: "Drafting a read-only SELECT that matches your tables.",
  },
  {
    id: "finish",
    title: "Finishing up",
    detail: "Preparing the generated statement for you.",
  },
];
